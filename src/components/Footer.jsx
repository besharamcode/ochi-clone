    ...
    <div className="h-screen w-full px-12">
      <div className="flex justify-between items-start h-full">
        <div className="flex flex-col justify-between h-full w-1/2">
          <h2 className="font-bebasNeue text-9xl font-bold tracking-wide leading-[7rem] mt-2">
            EYE- <br /> OPENING
          </h2>
          <svg
            className="mb-10"
        ...
        <div className="w-1/2 flex flex-col justify-between  h-full font-['neueMontreal']">
          <h2 className="font-bebasNeue text-9xl font-bold tracking-wide leading-[7rem] mt-2">
            Presentation
          </h2>
          <div>
            <h4 className="font-['neueMontreal']">S:</h4>
            <div className="mt-6">
              {["Instagram", "Behance", "Facebook", "Linkedin"].map(
                (word, i) => (
                  <p key={i} className="my-1 border-b-2 border-zinc-900 w-fit">
                    {word}
                  </p>
                )
              )}
          ...
          <div className="flex justify-between">
            <div>
              <h4 className="font-['neueMontreal']">L:</h4>
              <div className="mt-6 w-[15ch] flex flex-col gap-5">
                {[
            ...
            <div>
              <h4 className="font-['neueMontreal']">M:</h4>
              <div className="mt-6 w-[15ch] flex flex-col">
                {["Instagram", "Behance", "Facebook", "Linkedin"].map(
                  (word, i) => (
                    <p
                      key={i}
                      className="my-1 border-b-2 border-zinc-900 w-fit"
                    >
                      {word}
                    </p>
                  )
          ...
          <div>
            <h4 className="font-['neueMontreal']">E:</h4>
            <p className="my-1 border-b-2 border-zinc-900 w-fit">
              hello@ochi.design
            </p>
          </div>
          <div className="mb-8 flex justify-between items-center">
            <p className="text-zinc-600 font-bold tracking-wide w-fit">
